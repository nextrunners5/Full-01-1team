      ...
      case "terms":
        return (
          <div>
            <h3>1. 목적</h3>
            <p>
              본 약관은 서비스 이름을 제공하는 회사 이름과 서비스를 이용하는
              회원(이하 "회원")간의 권리, 의무 및 책임 사항을 규정합니다. 본
              서비스는 일정 관리, 프로젝트 관리, 투두리스트 및 1:1 채팅 기능을
              제공합니다.
            </p>
            <h3>2. 회원의 의무</h3>
            <ul>
              <li>
                회원은 서비스 이용 시 허위 정보를 입력하거나 타인의 개인정보를
                도용하지 않아야 합니다.
              </li>
              <li>
                회원은 서비스 이용 과정에서 저작권, 초상권 등 타인의 권리를
                침해해서는 안 됩니다.
              </li>
              <li>
                회원은 서비스를 악용하거나 서비스의 안정적 운영을 방해하는
                행위를 금지합니다.
              </li>
            </ul>
            <h3>3. 회사의 책임</h3>
            <ul>
              <li>
                회사는 회원의 개인정보를 보호하며, 관련 법령에 따라 이를
                처리합니다.
              </li>
              <li>
                회사는 서비스 제공과 관련하여 시스템의 안정성과 연속성을
                유지하기 위해 노력합니다.
              </li>
              <li>
                회사는 서비스 운영 중단 시 사전에 회원에게 공지하며, 부득이한
                경우 즉시 공지합니다.
              </li>
            </ul>
            <h3>4. 서비스의 변경 및 중단</h3>
            <p>
              회사는 서비스의 일부 또는 전체를 운영상 필요에 따라 변경하거나
              중단할 수 있습니다. 회사는 서비스 중단 또는 변경 시, 이를 회원에게
              사전 공지합니다. 단, 긴급한 경우 사후 공지가 가능합니다.
            </p>
            <h3>5. 서비스 이용 제한</h3>
            <p>
              회사는 회원이 다음 행위를 할 경우, 서비스 이용을 제한할 수
              있습니다.
            </p>
            <ul>
      ...
      case "policy":
        return (
          <div>
            <h3>1. 운영정책 기본원칙</h3>
            <p>
              본 운영정책은 서비스의 건전한 운영과 사용자 보호를 위해
              수립되었으며, 모든 사용자는 이를 준수해야 합니다.
            </p>
            <h3>2. 금지행위</h3>
            <ul>
            ...
            <h3>4. 신고처리</h3>
            <p>
              신고된 내용은 운영팀 검토 후 24시간 이내 처리되며, 처리 결과는
              신고자에게 통보됩니다.
            </p>
            <h3>5. 운영정책 기본원칙</h3>
            <p>
              운영정책은 서비스 환경 변화에 따라 수정될 수 있으며, 중요한
              변경사항은 공지사항을 통해 안내됩니다.
            </p>
          </div>
        );
      case "privacy":
        return (
          <div>
            ...
            <p>
              회사는 정보주체의 별도 동의가 있는 경우나 법령에 특별한 규정이
            ...
            <ul>
              ...
              <li>
                기술적 조치 : 개인정보처리시스템 등의 접근권한 관리, 접근
                통제시스템 설치
              </li>
